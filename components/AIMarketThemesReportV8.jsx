  ...
  const renderSection01 = () => (
    <section style={s.section}>
      ...
      <div style={s.mb32}>
        ...
        <p style={{ ...s.body, marginTop: '16px' }}>In institutional settings, investment risk extends well beyond portfolio volatility. It includes career risk, legal exposure, and reputational consequences. Portfolio managers and advisors are accountable not just to clients but to internal risk committees, compliance departments, auditors, and senior management. When a position underperforms, the central question is rarely whether the underlying insight was directionally correct. It is whether the decision could be justified, contemporaneously, using evidence that met institutional standards at the time.</p>
        <p style={{ ...s.body, marginTop: '16px' }}>That distinction matters. An insightful thesis that cannot be documented is not considered prudent. A conventional thesis that can be traced to accepted inputs often is.</p>
        <p style={{ ...s.body, marginTop: '16px' }}>As a result, institutional investment processes anchor decisions to auditable evidence: reported financials, earnings trajectories, valuation multiples, management guidance, and consensus estimates. These inputs create a defensible paper trail. They are slow, backward-looking, and often lag economic reality, but they are verifiable. They survive post-mortems, client reviews, and compliance scrutiny.</p>
        <p style={{ ...s.body, marginTop: '16px' }}>This framework does not exist because institutional investors fail to recognize early signals. It exists because acting on signals that have not yet translated into auditable data exposes decision-makers to asymmetric personal downside. If an early thesis proves correct, the upside accrues to the institution. If it proves early or mistimed, the cost to the individual is immediate and often irreversible. Rational actors respond by waiting for confirmation, even when they suspect the opportunity is already being repriced.</p>
        <p style={{ ...s.body, marginTop: '16px' }}>The consequence is structural, not behavioral. Capital pools governed by these constraints systematically delay action until qualitative insight becomes quantitatively defensible. By that point, uncertainty has declined, but so has optionality. The mispricing has narrowed. The most asymmetric portion of the return has already been claimed.</p>
        <p style={{ ...s.body, marginTop: '16px' }}>This does not imply that early action is always correct, or even frequently correct. Most early hypotheses are wrong. The edge does not come from acting on more early signals but from filtering aggressively for situations where downside is bounded, upside is driven by irreversible system constraints, and time works against competitors rather than for them. Institutional capital avoids early action because it must avoid false positives. Smaller capital can afford to reject 90% of early ideas and concentrate only where mispricing is both structural and persistent.</p>
        <p style={{ ...s.body, marginTop: '16px' }}>That optimization is appropriate for institutional mandates. It is also the reason excess returns persist elsewhere.</p>
      </div>
      ...
      <div style={s.mb32}>
        ...
        <p style={{ ...s.body, marginTop: '16px' }}>The paradox is this: the phase that looks undisciplined is where the returns concentrate. The phase that looks rigorous is often where they dissipate. This isn't a criticism of institutions that wait; they are doing exactly what their mandates require. It is an observation about where excess returns live and why they persist for those willing to operate differently.</p>
      </div>
