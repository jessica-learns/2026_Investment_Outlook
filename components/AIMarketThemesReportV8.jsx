  ...
  const renderSection01 = () => (
    <section style={s.section}>
      ...
      <div style={s.mb32}>
        ...
        <p style={{ ...s.body, marginTop: '16px' }}>The simultaneous arrival of artificial intelligence, energy transition, supply chain restructuring, and great power competition has created a generational collision of demand and constraint. Each of these forces individually would be significant. Together, they are reshaping the global economy in real time. Power demand is accelerating while grid infrastructure ages. Semiconductor complexity is increasing while fabs take years to build. Critical minerals are essential while processing remains concentrated. Defense spending is surging while industrial bases have hollowed out.</p>
        <p style={{ ...s.body, marginTop: '16px' }}>These are not temporary dislocations. They are structural features of the decade ahead. The companies that control the chokepoints in these systems will capture extraordinary value. The companies that merely participate will compete it away. The opportunity is not to predict which technologies win. It is to identify where physical constraints bind, and to position before that control is widely recognized.</p>
      </div>
