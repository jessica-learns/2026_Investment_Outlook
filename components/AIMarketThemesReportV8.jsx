  ...
  const renderSection01 = () => (
    <section style={s.section}>
      ...
      <div style={s.mb32}>
        ...
        <p style={{ ...s.body, marginTop: '16px' }}>That distinction reshapes behavior. Investment processes anchor to auditable inputs: reported financials, earnings trajectories, valuation multiples, management guidance, consensus estimates. These create defensible paper trails. They lag economic reality, but they survive post-mortems and compliance scrutiny. An insightful thesis that cannot be documented is not considered prudent. A conventional thesis that traces to accepted inputs often is.</p>
        <p style={{ ...s.body, marginTop: '16px' }}>This framework exists because acting on signals that haven't yet translated into auditable data exposes decision-makers to asymmetric personal downside. If an early thesis proves correct, the upside accrues to the institution. If it proves mistimed, the cost to the individual is immediate and often irreversible. The volatility profile compounds this problem. Earlier-stage growth companies are inherently more volatile, and even the right ones—the ones where volatility skews to the upside over time—will produce quarters that look catastrophic on a spreadsheet. Walking into a review meeting during one of those quarters, with a position down 30% and no near-term catalyst to point to, is a career-defining moment that most managers rationally avoid. They wait for confirmation, even when they suspect the opportunity is already being repriced.</p>
        <p style={{ ...s.body, marginTop: '16px' }}>The consequence is structural. Capital pools governed by these constraints systematically delay action until qualitative insight becomes quantitatively defensible. By that point, the mispricing has narrowed. The most asymmetric portion of the return has already been claimed.</p>
        <p style={{ ...s.body, marginTop: '16px' }}>This does not imply that early action is frequently correct. Most early hypotheses are wrong. The edge comes not from acting on more early signals but from filtering aggressively for situations where downside is bounded and time works against competitors rather than for them. Institutional capital avoids early action because it must avoid false positives. Smaller capital can reject 90% of early ideas and concentrate only where mispricing is both structural and persistent.</p>
      ...
      <div style={s.mb32}>
        ...
        <p style={{ ...s.body, marginTop: '16px' }}>
          In these environments, the market asks a fundamentally different question. Not: who is producing today? But: who is most likely to control production tomorrow? That question gets answered, and stocks reprice, long before the income statement confirms it. Here are four examples of stocks that repriced based on scarcity theses that Broadstreet purchased. The graph shows annual returns for the stocks compared to SPY, a popular S&P 500 ETF. The data is not adjusted for our specific purchase and sale (if applicable) dates.
        </p>
