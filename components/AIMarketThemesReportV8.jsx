...
export default function AIMarketThemesReportV8() {
  ...
  const renderSection01 = () => (
    <section style={s.section}>
      ...
      <div style={s.mb32}>
        <p style={s.body}>In November 2022, OpenAI released ChatGPT to the public. Within weeks, artificial intelligence went from research curiosity to the most important investment theme in a generation. The hyperscalers—Apple, Microsoft, Google, Amazon, Meta—would go on to drive the bulk of U.S. equity returns over the next two years.</p>
        <p style={{ ...s.body, marginTop: '16px' }}>But TSMC, a company that manufactures over 90% of the world's AI semiconductors, was about to outperform them all. At the moment of ChatGPT's launch, its stock was near multi-year lows—beaten down, overlooked, and priced as if AI demand wouldn't matter. It mattered. Over the past decade, TSMC returned 18x, outpacing every hyperscaler it supplies and the S&P 500 itself. The companies that captured the headlines ran on chips that only one company could make.</p>
